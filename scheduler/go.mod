...
require (
	...
	k8s.io/client-go v0.30.6 // indirect
	k8s.io/cloud-provider v0.30.6 // indirect
	...
	k8s.io/dynamic-resource-allocation v0.30.6 // indirect
	k8s.io/kms v0.30.6 // indirect
	k8s.io/kube-openapi v0.0.0-20240228011516-70dd3763d340 // indirect
	k8s.io/kube-scheduler v0.30.6 // indirect
	k8s.io/kubelet v0.30.6 // indirect
	k8s.io/mount-utils v0.30.6 // indirect
...
replace (
	...
	k8s.io/endpointslice => k8s.io/endpointslice v0.30.6
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.30.6
	k8s.io/sample-controller => k8s.io/sample-controller v0.30.6
)

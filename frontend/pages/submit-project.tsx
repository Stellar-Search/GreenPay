...
export default function SubmitProjectPage() {
  ...
  if (step === "done") {
    return (
      <div className="max-w-xl mx-auto px-4 py-20 text-center animate-fade-in">
        ...
        <p className="text-[#4b654b] font-body mb-2">
          Thank you for submitting <strong>{form.projectName}</strong>.
        </p>
        <p className="text-[#4b654b] font-body mb-8">
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10 animate-fade-in">
      ...
      <p className="text-[#4b654b] font-body mb-8 text-sm">
          ...
          <div key={s} className="flex items-center gap-2 flex-1">
            <div
              className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-colors ${
                i < stepIndex
                  ...
                  : "border-forest-200 text-[#547454] bg-white"
              }`}
            >
              {i < stepIndex ? "✓" : i + 1}
            </div>
            <span
              className={`text-xs font-body hidden sm:block ${
                i === stepIndex ? "text-forest-900 font-semibold" : "text-[#547454]"
              }`}
            >
              {STEP_LABELS[s]}
            </span>

...
function StatCard({
  ...
  return (
    <div className="stat-card flex flex-col gap-1">
      ...
      {sub && <p className="text-xs text-[#4b654b] font-body">{sub}</p>}
    </div>
  );
}
  ...
  return (
    <div className="flex items-center justify-between py-3 border-b border-[rgba(34,114,57,0.07)] last:border-0 gap-3">
      <div className="flex flex-col gap-0.5 min-w-0">
        ...
        {donation.message && (
          <p className="text-xs text-[#4b654b] italic truncate max-w-[200px] sm:max-w-sm">
            &quot;{donation.message}&quot;
          </p>
        )}
      </div>
      <div className="flex flex-col items-end gap-0.5 shrink-0">
        <span className="font-semibold text-[#227239] font-body text-sm">
          ...
          <span className="text-xs font-normal text-[#4b654b]">{currency}</span>
        </span>
        <span className="text-[10px] text-[#4b654b]">
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 gap-6">
      ...
      <div>
        ...
        <p className="text-[#4b654b] font-body max-w-sm mx-auto text-sm leading-relaxed">
          The donor at{" "}
      ...
      <div className="min-h-screen bg-leaf">
        <div className="max-w-2xl mx-auto px-4 py-10 space-y-6">
          ...
          <div className="card shadow-green">
            ...
            {profile.bio && (
              <p className="mt-4 text-sm text-[#4b654b] font-body leading-relaxed border-t border-[rgba(34,114,57,0.08)] pt-4">
                {profile.bio}
              </p>
            )}
          </div>
          ...
          <div className="card">
            ...
            {donations.length === 0 ? (
              <p className="text-sm text-[#4b654b] py-4 text-center font-body">

  ...
  if (!publicKey) return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-[#4b654b] font-body">Connect your wallet to see your donation history and impact</p>
      </div>
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 animate-fade-in">
      ...
      <div className="flex border-b border-forest-100 mb-6">
        <button
          ...
          className={`px-6 py-3 text-sm font-semibold transition-all border-b-2 ${activeTab === 'impact' ? 'border-forest-500 text-forest-900' : 'border-transparent text-[#547454] hover:text-forest-600'}`}
        >
          My Impact
        </button>
        <button
          onClick={() => setActiveTab('saved')}
          className={`px-6 py-3 text-sm font-semibold transition-all border-b-2 flex items-center gap-2 ${activeTab === 'saved' ? 'border-forest-500 text-forest-900' : 'border-transparent text-[#547454] hover:text-forest-600'}`}
        >
          Saved Projects
          {wishlist.length > 0 && (
          ...
          <div className="card">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-[#4b654b] font-body mt-1">
                ...
                {profile.badges.map((badge, i) => (
                  <div key={i} className="flex items-center gap-3 bg-forest-50/50 rounded-xl px-4 py-3 border border-forest-200/50 hover:bg-forest-50 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#547454] font-body uppercase tracking-widest font-bold opacity-80">Earned {timeAgo(badge.earnedAt)}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="card shadow-sm border border-forest-100/50">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-[#4b654b] mb-4 font-body">No donations yet</p>
                ...
                {donations.map(d => (
                  <div key={d.id} className="flex items-center gap-4 p-4 rounded-xl bg-forest-50/50 hover:bg-forest-50 transition-colors border border-transparent hover:border-forest-100/50">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {d.message && <p className="text-xs text-[#4b654b] italic font-body truncate">&quot;{d.message}&quot;</p>}
                      <p className="text-[10px] text-[#547454] font-body uppercase tracking-wider font-bold opacity-70">{timeAgo(d.createdAt)}</p>
                    </div>
        ...
        <div className="animate-slide-up">
          {savedProjects.length === 0 ? (
            <div className="card text-center py-20">
              ...
              <p className="text-[#4b654b] mb-8 font-body">Save projects you&apos;re interested in to track their progress.</p>
